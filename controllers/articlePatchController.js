...
async function updateArticle(req, res, next) {
    ...
    try {
        ...
        const existingArticle = await db.query('SELECT * FROM articles WHERE article_id = $1', [article_id]);
        ...
        const updatedArticle = await db.query('UPDATE articles SET votes = $1 WHERE article_id = $2 RETURNING *', [inc_votes, article_id]);
